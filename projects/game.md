...
To view the code, visit the [GitHub repository](https://github.com/Philip-R-Low/csci_121_final_project) I made for the project (four years after the project itself). To play the game, first ensure you have Python version 3.9 or later installed (earlier versions of Python may work but I make no promises), then in a command prompt, run the main.py file with python.