...
I read Eric Steven Raymond's essay [How To Ask Questions The Smart Way](http://www.catb.org/esr/faqs/smart-questions.html). Then I looked up the top rated questions on [StackOverflow](https://stackoverflow.com/questions). And I realized one of two things must be true: either what is considered a smart question has changed in the last two years, or there is more than one way to ask a smart question.

The top rated question on StackOverflow about generics does not follow Raymond's guide to asking a good question. It rather straightforwardly asks [what the difference is between interfaces and types in typescript](https://stackoverflow.com/questions/37233735/interfaces-vs-types-in-typescript). The question asker does not state that they've read the manual or that they have googled the answer, and yet nobody in the comments is raging at them to _read the f*cking manual_ or _search the f*cking web_. At least, not in the top rated replies. It is the top answerer, not the asker that notes the official documentation is outdated.

Raymond demands of readers who find his tone "obnoxious, condescending, or arrogant," to "check your assumptions." Unfortunately for him, I do feel the need to point out the hypocrisy there, as his tone in his introduction comes across as accusing the reader. Luckily, the more civil tone his instructions take is the tone most of those that answer questions on StackOverflow seem to take. Irony of his article telling readers that civility can only help after calling a large chunk of them idiots and losers aside, the advise is actually useful... **When it actually applies that is.**
